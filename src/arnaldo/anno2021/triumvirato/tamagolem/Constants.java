...
public class Constants {
	...
	//these are basic game info
	public static final String GAME_NAME="Tamagolem";
	public static final String[] MENU_SELECTION_OPTIONS= {"Gioca","Regole","Cambia elementi","attiva/disattiva musica"};
	...
	public static final String MUSIC_FILE_PATHNAME="resources/No_Copyright_Epic.wav";
	...
	//golem summoning and interactions messages
	...
	public static final String SECRET_INPUT_SUMMONING_MESSAGE="%s evoca il tuo golem; %s non guardare, chiunque osservi un evocatore durante il rituale verra' distrutto nel processo!";
	...
	//win announcing
	public static final String VICTORY_MESSAGE_COLTA_CIT="%s non ha piu' golem... %s vince! Tuuu(%s) hai perso!";
